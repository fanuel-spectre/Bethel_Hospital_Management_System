...
<?php
 //when payment button selected redirect to bank page
 if(isset($_POST['cbe'])){
    $name = $_GET['name'];
    $type = $_GET['type'];
...
<div class="modal fade" id="contactModal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form class="form login-form text center"  action="payment.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
