...
$sql = "INSERT INTO new(fname, lname, phoneno, add, username,email, password,security)VALUES('$fname', '$lname', '$phoneno', '$add', '$username', '$email', '$password','$security')";
    ...
    header("location: neww.php?pass=wrong&phoneno=$phoneno&llll=$e&phonenoo=$phonenoo&add=$add&username=$username&email=$email&password=$name");
  }
 }
?>
<!DOCTYPE html>
...
<body>
    ...
    <form class="form login-form text center"  action="neww.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
    <div class="alert alert-error"><?=$_SESSION['message']?></div>
         ...
         if(isset($_GET['e'])){
            $e=$_GET['e'];
            echo' <input type="text" name="llll"   class="form-control rounded-pill form-control-lg" placeholder="lllll" value="'.$e.'" required>';
        }
        else{
            echo' <input type="text" name="llll"   class="form-control rounded-pill form-control-lg" placeholder="lllll" required>';
        }
            ?><br>
           <strong> Phone No</strong><?php
            if(isset($_GET['phonenoo'])){
                $phonenoo=$_GET['phonenoo'];
                echo' <input type="text" name="phonenoo"   class="form-control rounded-pill form-control-lg" placeholder="Phone No" value="'.$phonenoo.'" required>';
            }
            else{
                echo' <input type="text" name="phonenoo"   class="form-control rounded-pill form-control-lg" placeholder="Phone No" required>';
            }
            ?><br>
            <strong>Adress</strong><?php
            if(isset($_GET['add'])){
                $add=$_GET['add'];
                echo' <input type="text" name="add"   class="form-control rounded-pill form-control-lg" placeholder="Adress" value="'.$add.'" required>';
            }
            else{
                echo' <input type="text" name="add"   class="form-control rounded-pill form-control-lg" placeholder="Adress" required>';
            }
            ?><br>
...
<strong>passs</strong><?php
            if(isset($_GET['password'])){
                $name=$_GET['password'];
                echo' <input type="text" name="password"   class="form-control rounded-pill form-control-lg" placeholder="mail" value="'.$name.'" required>';
            }
            else{
                
                echo' <input type="text" name="password"   class="form-control rounded-pill form-control-lg" placeholder="email" required>';
            }
            ?>
