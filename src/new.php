...
$sql = "INSERT INTO user(firstname, lastname, email, phoneno, adress, username, password,security)VALUES('$firstname', '$lastname', '$email', '$phoneno', '$adress', '$username', '$password','$security')";
    ...
    header("location: new.php?signup=password&firstname=$firstname&lastname=$lastname&phoneno=$phoneno&adress=$adress&username=$username&email=$email");
  }
 }
?>
<!DOCTYPE html>
...
<body>
    ...
    <form class="form login-form text center"  action="new.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
