...
$sql = "INSERT INTO message(fullname, email, phoneno, message)VALUES('$fullname', '$email', '$phoneno', '$message')";
 ...
 if(isset($_POST['number1'])){
   $houseno = "apartment one";
   header("location:payment2.php?name=$name&type=$type&subcity2=$subcity&houseno=$houseno");
 }
 if(isset($_POST['number2'])){
  $houseno = "apartment two";
  header("location:payment2.php?name=$name&type=$type&subcity2=$subcity&houseno=$houseno");
}
if(isset($_POST['number3'])){
  $houseno = "apartment three";
  header("location:payment2.php?name=$name&type=$type&subcity2=$subcity&houseno=$houseno");
}
if(isset($_POST['number4'])){
  $houseno = "apartment four";
  header("location:payment2.php?name=$name&type=$type&subcity2=$subcity&houseno=$houseno");
}
if(isset($_POST['number5'])){
  $houseno = "apartment five";
  header("location:payment2.php?name=$name&type=$type&subcity2=$subcity&houseno=$houseno");
}
  ...
  <div class="modal fade" id="contactModal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form class="form login-form text center"  action="slider2.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
