...
if(isset($_POST['bole'])){
  $subcity = "Bole";
  header("location:slider.php?name=$name&type=$type&subcity=$subcity");
}
    ...
    <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse sticky-top">
      ...
      <div class="containere">
        ...
        <div class="row">
          ...
          <form method="post">
          <button name="bole" class="btn mt-1 btn-custom btn-block text-uppercase rounded-pill btn-lg" style= "margin:0 120px; width: 15rem;" >Bole</button> </form>
...
<div class="modal fade" id="contactModal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <form class="form login-form text center"  action="subcity.php" method="post" enctype="multipart/form-data" autocomplete="off"> 
