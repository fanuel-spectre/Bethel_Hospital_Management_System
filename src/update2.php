...
if(isset($_POST['s']))
{
    ...
    mysql_query("update employees set firstname='$f', lastname='$l', email='$e', phoneno='$ph', adress='$a',  password='$p' where username='$u'");
              ...
              <div class="container-fluid">
                <div class="row content">
                  <div class="col-sm-3 sidenav ">
                    <h4><i class="fa fa-user"></i>Edit Employee Profile</h4>
                   <br><br>
