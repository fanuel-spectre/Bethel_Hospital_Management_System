              ...
              <div class="container-fluid">
                <div class="row content">
                  ...
                  <div class="col-sm-9 ">
                    ...
                    <hr>
                    <h4 class="list-off-customers text-center"><small>List Of Employee</small></h4>
                    <hr>
                    <table class="table">
                      <thead class="thead-inverse">
                      <tr>
                      ...
                      <tbody>
                        <?php
                        $con=mysqli_connect("localhost","root","","ayat");
                        $s=mysqli_query($con,"SELECT * FROM employees");
                        while ($r=mysqli_fetch_array($s)){
                        ?>
                        <tr>
                        <th><?php echo $r['eid'];?> </th>
                          <th><?php echo $r['firstname'];?> </th>
                          <th><?php echo $r['lastname'];?> </th>
                          <th><?php echo $r['email'];?> </th>
                          <th><?php echo $r['phoneno'];?> </th>
                          <th><?php echo $r['adress'];?> </th>
                          <th><a href="delete2.php?a=<?php echo $r['firstname']; ?>">Remove</a></th> 
                          <!-- <th><a href="#" data-toggle="modal" data-target="#contactModal3"><strong><i class="fa fa-info-circle"></i> Info</strong></a></th> -->
                        </tr>
                        <?php
                          }
                    ...
                    <hr>
                    <h4 class="list-off-customers text-center"><small>Employee  Message</small></h4>
                    <hr>
                    <table class="table">
                      <thead class="thead-inverse">
                        <tr>
                      ...
                      <tbody>
                        <?php
                        $con=mysqli_connect("localhost","root","","ayat");
                        $s=mysqli_query($con,"SELECT * FROM employemessage");
                        while ($r=mysqli_fetch_array($s)){
                        ?>
                        <tr>
                        <th><?php echo $r['messageid'];?> </th>
                          ...
                          <th><a href="employemessage.php?a=<?php echo $r['messageid']; ?>">Remove</a></th>      <!-- <th><a href="#" data-toggle="modal" data-target="#contactModal3"><strong><i class="fa fa-info-circle"></i> Info</strong></a></th> -->
                        </tr>
                        <?php
                          }
                          ?>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <th><?php echo $r['id'];?> </th>
                          ...
                          <th><?php echo $r['transaction_date'];?> </th>
                          <th><a href="admindeletetransaction.php?a=<?php echo $r['id']; ?>">Remove</a></th>
                          <!-- <th><a href="#" data-toggle="modal" data-target="#contactModal3"><strong><i class="fa fa-info-circle"></i> Info</strong></a></th> -->
                        </tr>
                        <?php
                          }
                  ...
                  <br><hr>
                   ...
                   <hr> 
                   <hr><br>
                    <h4 class="list-off-employee text-center"><small>Villa-Houses</small></h4> 
                    <table class="table">
                      <thead class="thead-inverse">
                        <tr>
                        <th>House id</th>
                      ...
                      <tbody>
                        <?php
                        $con=mysqli_connect("localhost","root","","ayat");
                        $s=mysqli_query($con,"SELECT * FROM house");
                        while ($r=mysqli_fetch_array($s)){
                        ?>
                        <tr>
                        <th><?php echo $r['houseid'];?> </th>
                          <th><?php echo $r['hname'];?> </th>
                          <th><?php echo $r['houseno'];?> </th>
                          <th><?php echo $r['htype'];?> </th>
                          <th><?php echo $r['hlocation'];?> </th>
                          <th><a href="Addhouse.php?a=<?php echo $row['firstname'];?>">ADD</a></th>
                          <th><a href="villadelete.php?a=<?php echo $r['houseid']; ?>">Remove</a></th>
                          <!-- <th><a href="#" data-toggle="modal" data-target="#contactModal3"><strong><i class="fa fa-info-circle"></i> Info</strong></a></th> -->
                        </tr>
                        <?php
                          }
                  ...
                  <br><hr>
                   ...
                   <hr> 
                    <br><br>
                    <hr><br>
                    <h4 class="list-off-employee text-center"><small>House-List</small></h4> 
                    <table class="table">
                      <thead class="thead-inverse">
                        <tr>
                        <th>House id</th>
                      ...
                      <tbody>
                        <?php
                        $con=mysqli_connect("localhost","root","","ayat");
                        $s=mysqli_query($con,"SELECT * FROM houselist");
                        while ($r=mysqli_fetch_array($s)){
                        ?>
                        <tr>
                        <th><?php echo $r['houseid'];?> </th>
