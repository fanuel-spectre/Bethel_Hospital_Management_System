...
<body>
    ...
    <form class="form login-form text center"  action="emp.php" method="post" enctype="multipart/form-data" autocomplete="off">
            <img class="avatar" src="img/profile pic.png">
            <h1 class="mb-5 font-weight-light text-uppercase">Employee Login</h1>     
            ...
            <button type="submit" name="employelogin" class="btn mt-5 btn-custom btn-block text-uppercase rounded-pill btn-lg">Login</button>
