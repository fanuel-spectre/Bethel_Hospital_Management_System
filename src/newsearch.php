...
<body>
              ...
              <div class="container-fluid">
                <div class="row content">
                  <div class="col-sm-3 sidenav ">
                    <h4><i class="fa fa-user"></i><strong> Customer</strong></h4>
                   <br><br>
                      <div class="button-group">
                        <a class="btn btn-outline-primary" href="update1.php" >Edit Profile</a> <br><br>
        ...
        if(isset($_POST['search']))
        {
            ...
            while($row=mysqli_fetch_array($query_run))
            {
                ...
                <th><?php echo $row['id'];?> </th>
                  ...
                  <th><a href="delete3.php?a=<?php echo $row['firstname']; ?>">Remove</a></th> 
                        <th><a href="update1.php?a=<?php echo $row['firstname'];?>">Change</a></th>
                </tr>
                <?php
            }
        ...
        <form action="" method="POST">
            <input type="text" name="fname" placeholder="Enter User Name to Search"/><br>
            <input type="submit" name="search" value="Search Data">

        </form>
        <div class="col-sm-9 ">
                    <br>
                   <h4 class="list-off-employee text-center"><small>List Of Transactions You Made</small></h4>
                    <hr>
                    <table class="table">
                      <thead class="thead-inverse">
                        <tr>
        ...
        {
            $fname = $_POST['fname'];
            $query="SELECT * FROM transaction where fname='$fname'";
            $query_run=mysqli_query($connection,$query);
            while($row=mysqli_fetch_array($query_run))
            {
                ?>
                ...
                <th><?php echo $row['id'];?> </th>
                  ...
                  <th><?php echo $row['villano'];?> </th>
                  <th><?php echo $row['payment'];?> </th>
                  <th><a href="delete4.php?a=<?php echo $row['id']; ?>">Remove</a></th>
